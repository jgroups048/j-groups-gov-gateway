...
import { MousePointerClick, Robot, CheckCircle } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {steps.map((step, index) => (
            <div key={index} className="step-card">
              <div className="flex items-center justify-center h-16 w-16 rounded-full bg-card/80 border border-primary/30 mb-4">
                {step.icon}
              </div>
